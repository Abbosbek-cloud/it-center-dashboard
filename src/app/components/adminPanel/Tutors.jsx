...
import { Avatar, Button, Card, Col, Form, Input, message, Modal, Row, Skeleton } from 'antd';
            ...
            <Col key={item._id} xs={24} sm={12} md={8} xl={6}>
              <Card
                ...
                actions={[
                  ...
                  <DeleteOutlined key="delete" onClick={() => onDelete(item._id)} />,
                ]}
              >
                <Skeleton loading={false} avatar active>
                  <Meta title={item.name.split(',').slice(0, 1)} description={`${item.description.slice(0, 15)}...`} />
                </Skeleton>
              </Card>
            </Col>
          ))
